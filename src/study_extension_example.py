...
file_name = "Example_extension"      # the first part of the file name, automatically appended with the respective simulation value and data description
                                    #DONT USE NUMBERS IN FILE NAME
folder_path = "../datasets/" + file_name + "PartTwo"   # where to save the data
